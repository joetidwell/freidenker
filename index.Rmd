...
display_post <- function(p,id) {
	out <- paste(
		paste0('<h2 style="margin-bottom: 0px; padding-bottom: 0px;">',p$title,'</h2>'),
...
<span class="copyleft">Everything contained in this website, including text, data, analyses, and visualizations is available to download as reproducible source code from a public [GitHub repository](https://github.com)</span>
<hr/>
