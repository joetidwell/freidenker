...
# Levied Taxes
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_COMBINED_RATE}}}` = levies_2023[`Taxing Unit Name`=="Boerne ISD",`M & O Rate` + `I & S Rate`][1])
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_LEVY}}}` = scales::label_comma()(levies_2023[`Taxing Unit Name`=="Boerne ISD",sum(`Calculated Levy`)]))
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_MARKET_VALUE}}}` = scales::label_comma()(levies_2023[`Taxing Unit Name`=="Boerne ISD",sum(`Market Value`)]))

# Tax Rate
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2005_TAX_RATE}}}` = BISD_combined_tax_rate[`Tax Year`==2005]$`Combined Tax Rate`)
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_TAX_RATE}}}` = BISD_combined_tax_rate[`Tax Year`==2023]$`Combined Tax Rate`)
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{MEDIAN_TAX_RANK}}}` = BISD_neighbors_combined_tax_rate[`School District`=="BOERNE ISD", median(Rank)])
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_TAX_RANK}}}` = BISD_neighbors_combined_tax_rate[`School District`=="BOERNE ISD" & `Tax Year` == 2023]$Rank)
...
# Enrollment
tags_source[["BISD"]] <- c(tags_source[["BISD"]],
                               `{{{2023_LEVY_PER_STUDENT}}}` = scales::label_comma()(round(round(levies_2023[`Taxing Unit Name`=="Boerne ISD",sum(`Calculated Levy`)]/directory[District.Name=="BOERNE ISD"]$`District.Enrollment.as.of.Oct.2023`[1]))))
